...
const CanvasRenderer = function(el, options) {
  ...
  const drawCircle = function(color, lineWidth, percent) {
    ...
    let isNegative = percent <= 0 ? true : false;
  ...
  this.animate = function(from, to) {
    ...
    const animation = function() {
      let process = Math.min(Date.now() - startTime, options.animate.duration);
      let currentValue = options.easing(this, process, from, to - from, options.animate.duration);
